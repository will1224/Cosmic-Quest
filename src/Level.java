...
public class Level {
    /**
     * The ID of the level. Uniquely identifies each level in increasing order from
     * 0-9 inclusive.
     */
    private int levelID;
    ...
    /**
     * Method makes five question objects, ensuring randomization and no repeats,
    ...
    private List<Question> readQuestions() {
        String resourcePath = "question.json"; // Correct path for resources

        try (InputStream inputStream = Level.class.getResourceAsStream(resourcePath)) {
            if (inputStream == null) {
    ...
    /**
     * Method returns a randomized list of five questions from the list of
     * questions.
     * 
    ...
    public List<Question> getQuestions() {
        ...
        if (questionList.size() < 5) {
            /**
             * If not, handle accordingly. For now, we're just printing a message and
             * returning the shuffled list as is.
             */
    ...
    public String getLesson() {
        String resourcePath = "lessons.json"; // Correct path for resources
        ...
        return "Lesson not found."; // Return a default message in case of error
    }
